...
- **[iTerm MCP Server](https://github.com/rishabkoul/TerminalMcp) - A Model Context Protocol (MCP) server implementation for iTerm2 terminal integration. Able to manage multiple iTerm Sessions
